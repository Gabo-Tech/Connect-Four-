...
Well, just visit the website at [gabriel19971029.github.io/Connect-Four-](https://gabriel19971029.github.io/Connect-Four-/) and enjoy! 

### You want to own this website?

On the other hand if you'd like to host this website on your local machine just clone this repository with ``` git clone https://github.com/gabriel19971029/Connect-Four-.git```. just copy and paste that command on your terminal, and dont foret pressing enter!
...
* Thanks to [Justin Kim](https://github.com/angle943) for teaching me DOM manipulation, and game logic. 
